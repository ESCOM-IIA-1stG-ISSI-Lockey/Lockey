...
CREATE OR REPLACE VIEW `ShippingDetail` AS
    SELECT     Shipping.*, nm_shpgtype, nm_wal, num_wal, OriginContact.nm_cont as nm_contorg, Origin.qr_shpgdr as qr_org, OriginDoor.nm_door as nm_drorg,OriginLocker.id_lkr as id_lkrorg, OriginLocker.nm_lkr as nm_lkrorg, DestinationContact.nm_cont as nm_contdst, Destination.qr_shpgdr as qr_dst, DestinationDoor.nm_door as nm_drdst, DestinationLocker.id_lkr as id_lkrdst, DestinationLocker.nm_lkr as nm_lkrdst
		FROM       Shipping
		NATURAL JOIN Wallet
